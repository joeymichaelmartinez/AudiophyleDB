...
SELECT band_name FROM band, band_Song, song WHERE song.song_name = 'Resonance' AND song.id = band_song.song_id;

/*What band wrote the album Odyssey*/
SELECT band_name FROM band, album_band, album WHERE album.album_name = 'Odyssey' AND album.id = album_band.album_id;
